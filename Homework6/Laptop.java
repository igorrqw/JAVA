...
// создание метода фильтрации
    public List<Laptop> filter(Set<Laptop> laptop) {
        Scanner scan = new Scanner(System.in);
        System.out.println("Здраствуйте, Укажите какие параметры для ноут бука вы бы хотели иметь." +
...
// создание метода фильтрации ноутбуков по выборочной критериям
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        ...
        System.out.println("Здравствуйте!\n Укажите номер критериев фильрации ноутбуков," + 
